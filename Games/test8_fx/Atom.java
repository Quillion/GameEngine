...
public class Atom extends Sprite
{
	...
	public Atom(double radius, Color fill)
	{
		...
		RadialGradient rgrad = RadialGradientBuilder.create()
													.centerX(
															sphere.getCenterX() - sphere
																	.getRadius() / 3)
													.centerY(
															sphere.getCenterY() - sphere
																	.getRadius() / 3)
													.radius(sphere.getRadius())
													.proportional(false)
													.stops(new Stop(0.0, fill),
														   new Stop(1.0,
																	Color.BLACK))
													.build();
	 ...
	 * 		Another atom
	 *
	 * @return boolean true if this atom and other atom has collided, otherwise
	 * false.
	 */
	...
	public void implode(final GameWorld gameWorld)
	{
		...
		FadeTransitionBuilder.create()
							 ...
							 .onFinished(new EventHandler<ActionEvent>()
							 {
								 ...
								 {
									 isDead = true;
									 gameWorld.getSceneNodes().getChildren()
											  .remove(node);
								 }
							 })
							 .build()
