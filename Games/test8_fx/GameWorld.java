 ...
 *  <b>beginGameLoop()</b> - Creates a JavaFX Timeline object containing the
 * game life cycle.
 *  <b>updateSprites()</b> - Updates the sprite objects each period (per frame)
 *  <b>checkCollisions()</b> - Method will determine objects that collide with
 * each other.
 *  <b>cleanupSprites()</b> - Any sprite objects needing to be removed from
 * play.
 * </pre>
 *
 * @author cdea
...
public abstract class GameWorld
{
	...
	protected final void buildAndSetGameLoop()
	{
		final Duration oneFrameAmt = Duration
				.millis(1000 / (float) getFramesPerSecond());
	 ...
	 *
	 * @param primaryStage
	 * 		The main window containing the JavaFX Scene.
	 */
	 ...
	 *
	 * @param spriteA
	 * 		- called from checkCollision() method to be compared.
	 * @param spriteB
	 * 		- called from checkCollision() method to be compared.
	 *
	 ...
	 *
	 * @param gameLoop
	 * 		Timeline object of an animation running indefinitely representing the
	 * 		game loop.
	 */
	 ...
	 *
	 * @param sceneNodes
	 * 		The root container having many children nodes to be displayed into the
	 * 		Scene area.
	 */
