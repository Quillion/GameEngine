...
/**
 */
public abstract class GameClient extends AbstractGameClient
{
	/**
	...
	public void init()
	{
		...
		panel.add(canvas);
		// ADD LISTENERS
		canvas.addKeyListener(new GameClient.KeyInputHandler(this));
		canvas.addMouseListener(new GameClient.MouseControl(this));
		canvas.addMouseMotionListener(new GameClient.MouseMotion(this));
